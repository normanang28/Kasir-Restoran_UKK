<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <div class="right-aligned">
                <?php if(!empty($search)) {?>
                    <a href="<?= base_url('/home/employee_activity/')?>"><button class="btn btn-info"><i class="fa fa-reply"></i> Back</button></a>
                <?php }?>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($duar as $gas){
                          ...
                          <tr>
                              ...
                              <td class="text-capitalize text-center"><?php echo $gas->tanggal_activity?></td>
                          </tr>
                      <?php }?>
    ...
    function displayDataOnPage(page) {
        ...
        for (let i = startIndex; i < endIndex && i < data.length; i++) {
            ...
            <td class="text-capitalize text-center text-dark">${gas.tanggal_activity}</td>
            </tr>
            `;
