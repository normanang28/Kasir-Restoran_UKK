...
<body>
<script>
  // Waktu timeout dalam milidetik (misal: 10 menit)
  const timeoutDuration = 600000; // 10 menit
  let timeout;

  // Fungsi untuk mengatur timeout dan logout otomatis
  ...
  // Fungsi logout
  function logout() {
    // Gantikan bagian ini dengan logika logout sesuai kebutuhan Anda
    // Contoh: Redirect ke halaman logout atau panggil fungsi logout dari server
        ...
        ***********************************-->
        <div class="nav-header">
            <a class="brand-logo" href="<?= base_url('/home/dashboard')?>" >
                ...
                <!-- <img class="logo-abbr" src="images/sph.png" alt="">
                <img class="logo-compact" src="images/text.png" alt="">
                <img class="brand-title" src="images/text.png" alt=""> -->

                <img class="logo-abbr" src="<?= base_url('/assets/images/settings_web/'.session()->get('foto_sekolah'))?>" alt="">
                <img class="brand-title" src="<?= base_url('/assets/images/settings_web/'.session()->get('text_sekolah'))?>" alt="">
            </a>
        ...
        ***********************************-->
        <div class="header">
            <div class="header-content">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
									<div class="header-info">
										<span >Hello, <strong class="text-capitalize"><?= session()->get('nama_pengguna')?></strong></span>
									</div>
                ...
                <?php }else{ ?>
                                    <img src="<?= base_url('/assets/images/profile/default-profile-photo.jpg')?>" width="20" alt=""/>
				<?php } ?>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?= base_url('/home/profile')?>" class="dropdown-item ai-icon">
                                    ...
                                    <a href="<?= base_url('/home/log_activity')?>" class="dropdown-item ai-icon">
									    <svg id="icon-key" xmlns="http://www.w3.org/2000/svg" class="text-orange" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" title="Log Activity">
									        <path d="M4 4h16c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2H6c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h6"></path>
									        <circle cx="8" cy="12" r="3" stroke="none"></circle>
									    </svg>
									    <span class="ms-2">Log Activity</span>
									</a>
									<style>
										.text-orange {
									    color: orange;
                                    ...
                                    <a href="<?= base_url('/home/log_out')?>" class="dropdown-item ai-icon">
