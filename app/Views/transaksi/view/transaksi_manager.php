    ...
    <div class="card">
        <div class="card-body">
           ...
           <div class="right-aligned">
            <?php if(!empty($search)) {?>
                <a href="<?= base_url('/home/transaction_m/')?>"><button class="btn btn-info"><i class="fa fa-arrow-left"></i> Back</button></a>
            <?php }?>
        </div>
        ...
        <div class="header-left">
            <form action="<?= base_url('home/transaksi__search') ?>" method="post">
                <div class="input-group search-area">
                    <input type="text" class="form-control text-capitalize" name="search__transaksi" placeholder="Search here...">
